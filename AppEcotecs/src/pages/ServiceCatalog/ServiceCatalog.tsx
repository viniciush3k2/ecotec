            ...
            <View>
                ...
                <FlatList
                    ...
                    renderItem={
                        (
                            { item: categorias }) => (
                                <TouchableOpacity style={styles.buttonTest} onPress={() => {}}>
                                    <Image source={categorias.img} style={styles.iconButton} />
                                    <Text style={styles.textoButton}>{categorias.title}</Text>
                                </TouchableOpacity>
                        )
                    }
                />
                ...
                <ScrollView contentContainerStyle={stylesFlatlistServicos.contentContainer}>
                    <FlatList
                        showsVerticalScrollIndicator={false}
                        // style={{height:Dimensions.get('screen').height,paddingHorizontal:0,paddingBottom:40}}
                        data={DataServicos}
                        ...
                        renderItem={
                            (
                                ...
                                <Image source={{uri:servicos.img}} style={stylesFlatlistServicos.iconButton} />
                                    <View>
                                        <Text style={stylesFlatlistServicos.titleButton}>{servicos.title}</Text>
                                        <Text style={stylesFlatlistServicos.descriptionButton}>Serviço oferecido por:</Text>
                                        <Text style={stylesFlatlistServicos.providerButton}>{servicos.provider}</Text>


                                        <Text style={stylesFlatlistServicos.textPrice}>{servicos.preco}</Text>
                                    </View>
                                </TouchableOpacity>
